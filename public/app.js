...
// called after preload
        function create () {
            ...
            asteroids.scoreText = this.game.add.text(this.game.width - 20, 20, "Score: " + this.score, {font: '20px Arial', fill: '#FFFFFF', align: 'center'})
            asteroids.scoreText.anchor.set(1,0)
